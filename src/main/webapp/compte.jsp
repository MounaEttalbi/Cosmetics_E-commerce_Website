  ...
  <div class="sidebar">
    <div class="mobile-navbar" data-navbar>
      ...
      <ul class="navbar-list">
        ...
        <li>
          <a href="products.jsp" class="navbar-link" data-nav-link>products</a>
        </li>
...
<section>
    <div class="content-container">
       ...
       <main class="description">
            <div class="container">
    <form method="get" action="InscriptionServlet" class="border" >
      <h3>Gestion des comptes</h3>
     <table class="table table-hover table-dark"s>
     <tbody>
          <tr>
           <th>ID</th>
            <th>username</th>
    ...
    <c:set var="username" value="${element.username}"/>
    <c:set var="password" value="${element.password}"/>
    <c:set var="fullname" value="${element.fullname}"/>
        <tbody>
          <tr>
     ...
     <button name="ajouter"  class="btn btn-danger"><a style="color: #000000" href="inscription.jsp" class="signup-image-link">add compte</a></button>
    </div>
        </main>
    </div>
</section>
